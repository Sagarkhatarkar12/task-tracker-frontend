...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.errors?.[0]?.msg || 'Something went wrong');
    }
  };
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 bg-gray-50 min-h-screen">
      ...
      <DashboardStats total={total} pending={pending} completed={completed} highPriority={highPriority} />
